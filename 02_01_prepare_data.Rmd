...
sample_metadata <- read_tsv("data/metagenomics/sample_metadata.tsv")
```
...
genome_length <- read_tsv("data/metagenomics/genome_length.tsv")
```

### Genome metadata

```{r generate_genome_metadata, warning=FALSE, comments="", message=FALSE}
genome_metadata <- inner_join(genome_taxonomy,genome_length,by=join_by(genome==genome))
```
