...
```{r gift_distillation, comment="", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r GIFTs_elements_plot, comment="", echo=FALSE, message=FALSE, warning=FALSE, fig.height=15, fig.width=10, fig.fullwidth=TRUE}
...
```{r GIFTs_functions_plot, comment="", echo=FALSE, message=FALSE, warning=FALSE}
